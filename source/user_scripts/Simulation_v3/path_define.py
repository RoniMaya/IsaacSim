...
STAGE_PATH_LATRUN_3         = apath("latrun","latrun_1_3000-all","odm_texturing", "cropped_1_3000.usd")
STAGE_PATH_LATRUN_2       = apath("latrun","Task-of-2025-09-27T063558178Z-all", "odm_texturing", "croped_odm_textured_model_geo.usd")
STAGE_PATH_LATRUN_1       = apath("latrun","latrun_5000_7999-all","odm_texturing", "cropped_5000_7999.usd")
...
COORDINATES_LATRUN_3    = apath("latrun","latrun_1_3000-all", "odm_georeferencing","coords.txt")
COORDINATES_LATRUN_2    = apath("latrun","Task-of-2025-09-27T063558178Z-all", "odm_georeferencing","coords.txt")
COORDINATES_LATRUN_1    = apath("latrun","latrun_5000_7999-all", "odm_georeferencing","coords.txt")
