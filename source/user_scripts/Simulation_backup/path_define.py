...
BASE = os.environ.get("OMNI_ASSETS", "/mnt/omniverse_assets").rstrip("/")
...
STAGE_PATH         = apath("ogmar", "z_upv2.usd")
CAR_ASSET_PATH     = apath("car", "car_v7.usd")
VAN_ASSET_PATH     = apath("car", "car_v9_rough.usd")
