...
def create_ptz_camera(stage, prim_path, translation,
    ...
    z_base   = translation[2] + hb*0.005
    z_middle = z_base + hb*0.005 + gap + hm*0.2
    z_child  = z_middle + hm*0.2 + gap + hc*0.1
    ...
    camera_base = Asset(f"{prim_path}/base", rigid_prim=False, scale=scale_base)
