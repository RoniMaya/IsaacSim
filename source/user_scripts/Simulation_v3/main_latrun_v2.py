...
from path_define import (
    CFG_FILE,STAGE_PATH_LATRUN_1,STAGE_PATH_LATRUN_2, STAGE_PATH_LATRUN_3,
    STAGE_PATH_LATRUN_5,
    TEXTURE_SKY,WHITE_TOYOTA,TANK,MEHOLA,STAGE_PATH_LATRUN_4,COORDINATES_LATRUN_4,COORDINATES_LATRUN_5,HAMAS,RADAR,KELA,
    RADAR_PROP_PATH, COORDINATES_LATRUN_1,COORDINATES_LATRUN_2,COORDINATES_LATRUN_3,  
     GEOJSON_LATRUN,RCS_FILE_PATH
)
